...
ggplot(present, aes(x=prop_boys,y=year)) + geom_line()
```
...
present = present %>% mutate(moreboys = boys>girls)
table(present$moreboys)
```
...
present = present %>% mutate(boytogirl2 = girls/boys)
ggplot(present, aes(x=year,y=boytogirl2)) + geom_line()
