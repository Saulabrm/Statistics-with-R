...
us12 %>% group_by(response) %>% summarize(n =n()) %>% mutate(prop = n/sum(n))
```
...
inference(y = response, x = year,data = spain, type="ht",statistic = "proportion",
          method = "theoretical",
...
inference(y = response, x = year,data = us, type="ht",statistic = "proportion",
          method = "theoretical",
          success = "atheist", alternative = "twosided")
```
